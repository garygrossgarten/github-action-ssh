...
export class PasswordResetPage implements OnInit {
  ...
  reset(loading: FivLoadingProgressBar) {
    ...
    this.api.resetOwnPassword(this.email.value)
      .subscribe(() => {
        loading.complete({});
        this.toast.success(12000, 'Ihr Passwort wurde zurückgesetzt. Bite überprüfen Sie Ihre E-Mails um die Zurücksetzung abzuschließen.', 'OK');
      }, err => {
        this.toast.error(8000, 'Ein Fehler ist aufgetreten. Bitte versuchen Sie es spätter erneut', 'OK');
        loading.unload();
      });
  }
