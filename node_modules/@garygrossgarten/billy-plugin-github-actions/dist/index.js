...
let GithubActionsPlugin = class GithubActionsPlugin {
    release() {
        return __awaiter(this, void 0, void 0, function* () {
            const currentBranch = yield this.exec("git branch | grep * | cut -d ' ' -f2");
            yield this.exec("git checkout -b release", true);
            ...
            yield this.exec(`git checkout -b ${currentBranch}`, true);
